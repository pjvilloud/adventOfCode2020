...
fields_validation = ["19[2-9][0-9]|200[0-2]", "201[0-9]|2020", "202[0-9]|2030",
                     "1[5-8][0-9]cm|19[0-3]cm|59in|6[0-9]in|7[0-6]in", "#[0-9a-f]{6}",
                     "amb|blu|brn|gry|grn|hzl|oth", "[0-9]{9}", ".*"]

passports = map(lambda p: p.replace(" ", "\n"), re.split("\n\n", input))
test_pass = passports[0]
...
for passport in passports:
    ...
    if "".join(mask).startswith("1111111"):
        number_of_valid_passports += 1

print "There are", number_of_valid_passports, "valid passports"
