listNumbers = [1706, 1466, 1427, 1744, 1684, 1386, 2001, 1750, 1753, 1770, 1559, 1616, 1408, 1860, 1940, 2002, 1862,
...
for i1 in range(len(listNumbers) - 1, 0, -1):
    for i2 in range(len(listNumbers)):
        if i1 < i2 and listNumbers[i1] + listNumbers[i2] == 2020:
            print "Winner is: ", listNumbers[i1], " * ", listNumbers[i2], " = ", listNumbers[i1] * listNumbers[i2]
        i2 = i2 + 1
    i1 = i1 - 1

for i1 in range(len(listNumbers) - 1, 0, -1):
    for i2 in range(len(listNumbers)):
        for i3 in range(1, len(listNumbers)):
            if i2 < i3 and listNumbers[i1] + listNumbers[i2] + listNumbers[i3] == 2020:
                print "Winner is: ", listNumbers[i1], " * ", listNumbers[i2], " * ", listNumbers[i3], " = ", \
                    listNumbers[i1] * listNumbers[i2] * listNumbers[i3]
                break
            i3 = i3 + 1
        else:
            i2 = i2 + 1
